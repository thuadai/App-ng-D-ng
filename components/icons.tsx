...
export const GlobeIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h1a2 2 0 002-2v-1a2 2 0 012-2h1.945M7.704 4.04a9 9 0 1011.592 0M12 3v1m0 16v1m-6.04-3.04l-1.414 1.414M19.454 5.454l-1.414 1.414" />
  </svg>
);
...
export const AudioLoadingIcon: React.FC<{ className?: string }> = ({ className }) => (
...
export const MicrophoneIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19 11a7 7 0 11-14 0m7 6v4m0 0H8m4 0h4m-4-8a3 3 0 013 3v3a3 3 0 01-6 0v-3a3 3 0 013-3z" />
    </svg>
);